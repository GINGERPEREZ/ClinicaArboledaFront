...
export default {
  ...
  data() {
    return {
      ...
      limites: LIMITES,
      especialidades: [
        { id: 1, nombre: 'Medicina Crítica', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_medicina-critica.png' },
        { id: 2, nombre: 'Ortopedia y Traumatología', categoria: 'clinicas', destacada: true, icon: '/IC-Especialidades/IC_ortopedia.png' },
        ...
        { id: 10, nombre: 'Medicina Interna', categoria: 'clinicas', destacada: true, icon: '/IC-Especialidades/IC_medicina-interna.png' },
        { id: 11, nombre: 'Psiquiatría', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_psiquiatria.png' },
        { id: 12, nombre: 'Imagenología', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_imagenologia.png' },
        { id: 13, nombre: 'Cardiología', categoria: 'clinicas', destacada: true, icon: '/IC-Especialidades/IC_cardiologia.png' },
        { id: 14, nombre: 'Angiología y Cirugía Vascular', categoria: 'cirugias', destacada: false, icon: '/IC-Especialidades/IC_angiologia.png' },
        ...
        { id: 18, nombre: 'Endocrinología Pediátrica', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_endocrinologia_pediatrica.png' },
        { id: 19, nombre: 'Otorrinolaringología', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_otorrinolaringologia.png' },
        { id: 20, nombre: 'Urología', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_urologia.png' },
        { id: 21, nombre: 'Dermatología', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_dermatologia.png' },
        { id: 22, nombre: 'Dermatología Pediátrica', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_dermatologia_pediatrica.png' },
        { id: 23, nombre: 'Coloproctología', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_coloproctologia.png' },
        { id: 24, nombre: 'Fisioterapia', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_fisioterapia.png' },
        { id: 25, nombre: 'Fisiatría', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_fisiatria.png' },
        { id: 26, nombre: 'Odontología y Endodoncia', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_odontologia.png' },
        { id: 27, nombre: 'Cardiología Pediátrica', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_cardiologia_pediatrica.png' },
        { id: 28, nombre: 'Nutrición', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_nutricion.png' },
        { id: 29, nombre: 'Hematología', categoria: 'clinicas', destacada: false, icon: '/IC-Especialidades/IC_hematologia.png' },
      ],
      medicos: [
