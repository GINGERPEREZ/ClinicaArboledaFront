  ...
  data() {
    return {
      ...
      especialidadesMedicas: [
        ...
        { id: 3,  nombre: 'Neumonología',                  icon: '/IC-Especialidades/IC_neumonologia.png', medicos: 0 },
        ...
        { id: 6,  nombre: 'Pediatría y Neonatología',      icon: '/IC-Especialidades/IC_pediatria.png', medicos: 3 },
        { id: 7,  nombre: 'Cirugía Pediátrica',            icon: '/IC-Especialidades/IC_cirugia-pediatrica.png', medicos: 1 },
        { id: 8,  nombre: 'Anestesiología y Reanimación',  icon: '/IC-Especialidades/IC_anestesiologia.png', medicos: 3 },
        { id: 9,  nombre: 'Ginecología y Obstetricia',     icon: '/IC-Especialidades/IC_ginecologia.png', medicos: 3 },
        { id: 10, nombre: 'Medicina Interna',              icon: '/IC-Especialidades/IC_medicina-interna.png', medicos: 1 },
        { id: 11, nombre: 'Psiquiatría',                   icon: '/IC-Especialidades/IC_psiquiatria.png', medicos: 0 },
        { id: 12, nombre: 'Imagenología',                  icon: '/IC-Especialidades/IC_imagenologia.png', medicos: 0 },
        ...
        { id: 16, nombre: 'Neurología',                    icon: '/IC-Especialidades/IC_neurologia.png', medicos: 0 },
        { id: 17, nombre: 'Nefrología',                    icon: '/IC-Especialidades/IC_nefrologia.png', medicos: 0 },
        { id: 18, nombre: 'Endocrinología Pediátrica',     icon: '/IC-Especialidades/IC_endocrinologia_pediatrica.png', medicos: 1 },
        { id: 19, nombre: 'Otorrinolaringología',          icon: '/IC-Especialidades/IC_otorrinolaringologia.png', medicos: 1 },
        { id: 20, nombre: 'Urología',                      icon: '/IC-Especialidades/IC_urologia.png', medicos: 2 },
        { id: 21, nombre: 'Dermatología',                  icon: '/IC-Especialidades/IC_dermatologia.png', medicos: 1 },
        { id: 22, nombre: 'Dermatología Pediátrica',       icon: '/IC-Especialidades/IC_dermatologia_pediatrica.png', medicos: 1 },
        { id: 23, nombre: 'Coloproctología',               icon: '/IC-Especialidades/IC_coloproctologia.png', medicos: 1 },
        { id: 24, nombre: 'Fisioterapia',                  icon: '/IC-Especialidades/IC_fisioterapia.png', medicos: 1 },
        { id: 25, nombre: 'Fisiatría',                     icon: '/IC-Especialidades/IC_fisiatria.png', medicos: 1 },
        { id: 26, nombre: 'Odontología y Endodoncia',    icon: '/IC-Especialidades/IC_odontologia.png', medicos: 1 },
        { id: 27, nombre: 'Cardiología Pediátrica',        icon: '/IC-Especialidades/IC_cardiologia_pediatrica.png', medicos: 1 },
        { id: 28, nombre: 'Nutrición',                     icon: '/IC-Especialidades/IC_nutricion.png', medicos: 1 },
        { id: 29, nombre: 'Hematología',                   icon: '/IC-Especialidades/IC_hematologia.png', medicos: 1 },
      ],
      ...
      conveniosLogos: [
        ...
        { id: 'privado-1', nombre: 'Asisken', logo: '/Logos/Convenios/asisken.jpg' },
        { id: 'privado-2', nombre: 'Confiamed', logo: '/Logos/Convenios/Confiamed.jpg' },
        { id: 'privado-3', nombre: 'Ecuasanitas', logo: '/Logos/Convenios/ecuasanitas.png' },
        { id: 'privado-4', nombre: 'Humana', logo: '/Logos/Convenios/humana.jpg' },
        { id: 'privado-5', nombre: 'Latina Seguros', logo: '/Logos/Convenios/Latina.jpg' },
        { id: 'privado-6', nombre: 'MEDEC', logo: '/Logos/Convenios/medec.jpg' },
        { id: 'privado-7', nombre: 'MEDI', logo: '/Logos/Convenios/medi.png' },
        { id: 'privado-8', nombre: 'MEDIKEN', logo: '/Logos/Convenios/mediken.jpg' },
        { id: 'privado-9', nombre: 'PAL', logo: '/Logos/Convenios/PAL.png' },
        { id: 'privado-10', nombre: 'Plan Vital', logo: '/Logos/Convenios/Plan-vital.png' },
        { id: 'privado-11', nombre: 'Privilegio', logo: '/Logos/Convenios/privilegio.png' },
        { id: 'privado-12', nombre: 'Proassis Life', logo: '/Logos/Convenios/proassislife.jpg' },
        { id: 'privado-13', nombre: 'Saludsa', logo: '/Logos/Convenios/saludsa.png' },
        { id: 'privado-14', nombre: 'Sweaden', logo: '/Logos/Convenios/sweaden.png' },
        { id: 'privado-15', nombre: 'Vida Buena', logo: '/Logos/Convenios/vida buena.jpg' },
      ],
